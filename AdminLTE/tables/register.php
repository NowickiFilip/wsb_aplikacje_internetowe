  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="../skrypty/register.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="name" class="form-control" placeholder="Podaj nazwisko" name="lastName">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Powórz hasło" name="pass2">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
        ...
        <div class="input-group mb-3">
          <input type="date" class="form-control" name="Data Urodzenia" >
          <div class="input-group-append">
            <div class="input-group-text">
          ...
          <div class="col-7">
            <div class="icheck-primary">
              ...
              <label for="agreeTerms">
               Zatwierdz warunki <a href="#">Regulamin</a>
              </label>
            </div>
          </div>
          <!-- /.col -->
